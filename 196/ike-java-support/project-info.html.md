...
canonical_url: https://ike.network/ike-tooling/ike-java-support/project-info.html
---
...
| --- | --- |
| [About](index.html)[2] | JDK-only generic Java utilities shared across the IKE Maven plugins. First inhabitant: ConstantBackedEnum, which lets an enum-backed name be used as a constant-expression annotation element value. |
