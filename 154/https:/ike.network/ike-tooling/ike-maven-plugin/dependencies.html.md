...
| network.ike.tooling | [ike-maven-plugin-support](https://ike.network/ike-tooling/ike-maven-plugin-support/)[3] | 154 | jar | [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)[2] |
| network.ike.tooling | [ike-workspace-model](https://ike.network/ike-tooling/ike-workspace-model/)[4] | 154 | jar | [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)[2] |
...
| --- | --- | --- | --- | --- | --- |
| network.ike.tooling | [ike-build-standards](https://ike.network/ike-tooling/ike-build-standards/)[20] | 154 | claude | zip | [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)[2] |
...
- network.ike.tooling:ike-maven-plugin:maven-plugin:154 ** 
  ...
  | **Description: **Cross-platform Maven plugin providing release, documentation rendering, site deployment, and build management goals for IKE projects. Workspace goals are in ike-workspace-maven-plugin (ws: prefix). **URL: **[https://ike.network/ike-tooling/ike-maven-plugin/](https://ike.network/ike-tooling/ike-maven-plugin/)[105] **Project Licenses: **[Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)[2] |
    ...
    - network.ike.tooling:ike-build-standards:zip:claude:154 (provided) ** 
    ...
    - network.ike.tooling:ike-maven-plugin-support:jar:154 (compile) ** 
...
| ike-build-standards-154-claude.zip | 81 kB | - | - | - | - | - |
| ike-maven-plugin-support-154.jar | 38 kB | 31 | 19 | 2 | 25 | Yes |
