...
```
<dependency org="network.ike.tooling" name="ike-build-standards" rev="209">
...
```
@Grapes(
@Grab(group='network.ike.tooling', module='ike-build-standards', version='209')
)
```
...
```
implementation 'network.ike.tooling:ike-build-standards:209'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.tooling" % "ike-build-standards" % "209"
```
