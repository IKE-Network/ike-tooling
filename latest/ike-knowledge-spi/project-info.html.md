...
canonical_url: https://ike.network/ike-tooling/ike-knowledge-spi/project-info.html
---
...
| --- | --- |
| [About](index.html)[2] | Zero-dependency contract module for the IKE knowledge pipeline: ServiceLoader service interfaces (assemble, export, bindings, verify), the ViewSpec dimension vocabulary, and the properties codec that crosses the forked-JVM execution seam. |
