...
canonical_url: https://ike.network/ike-tooling/ike-build-report-extension/project-info.html
---
...
| --- | --- |
| [About](index.html)[2] | Maven 4 build extension that distills structured session events into an ike꞉build-report.md receipt, compared against a committed ledger of accepted findings with expected counts. Report-only in Phase 1; session-end gating arrives in Phase 2. |
