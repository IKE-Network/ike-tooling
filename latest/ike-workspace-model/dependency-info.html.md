...
```
<dependency org="network.ike.tooling" name="ike-workspace-model" rev="250">
...
```
@Grapes(
@Grab(group='network.ike.tooling', module='ike-workspace-model', version='250')
)
```
...
```
implementation 'network.ike.tooling:ike-workspace-model:250'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.tooling" % "ike-workspace-model" % "250"
```
