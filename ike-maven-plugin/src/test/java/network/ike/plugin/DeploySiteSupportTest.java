...
/**
 * Tests for pure functions extracted from {@link DeploySiteDraftMojo}:
...
class DeploySiteSupportTest {
    ...
    void toPublicSiteUrl_releaseUrl() {
        ...
        assertThat(DeploySiteDraftMojo.toPublicSiteUrl(scp))
    ...
    void toPublicSiteUrl_noPrefix_unchanged() {
        ...
        assertThat(DeploySiteDraftMojo.toPublicSiteUrl(url))
