...
```
<dependency org="network.ike.tooling" name="ike-maven-plugin-support" rev="250">
...
```
@Grapes(
@Grab(group='network.ike.tooling', module='ike-maven-plugin-support', version='250')
)
```
...
```
implementation 'network.ike.tooling:ike-maven-plugin-support:250'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.tooling" % "ike-maven-plugin-support" % "250"
```
