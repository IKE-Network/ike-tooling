...
```
<dependency org="network.ike.tooling" name="ike-build-standards" rev="235">
...
```
@Grapes(
@Grab(group='network.ike.tooling', module='ike-build-standards', version='235')
)
```
...
```
implementation 'network.ike.tooling:ike-build-standards:235'
```

## [Scala SBT](#scala-sbt)

```
libraryDependencies += "network.ike.tooling" % "ike-build-standards" % "235"
```
