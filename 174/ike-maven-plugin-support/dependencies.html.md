...
Full transitive dependency graph for `ike-maven-plugin-support` 174, generated from [bom.json](bom.json)[1] (CycloneDX 1.6) at build time. Same SBOM source as the SPDX-grouped [licenses.html](licenses.html)[2] and the curated [built-with.html](built-with.html)[3] — three views of the same data.
...
| `org.ow2.asm` | `asm` | `9.3` | `BSD-3-Clause` | library |
| `org.ow2.asm` | `asm-analysis` | `9.3` | `BSD-3-Clause` | library |
| `org.ow2.asm` | `asm-tree` | `9.3` | `BSD-3-Clause` | library |
| `org.ow2.asm` | `asm-util` | `9.3` | `BSD-3-Clause` | library |
...
- As a Maven artifact: pull `ike-maven-plugin-support:​174` with `<classifier>cyclonedx</classifier><type>json</type>` from Nexus / Maven Central.
